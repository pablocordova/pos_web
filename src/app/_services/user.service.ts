/**
 * The user service contains a standard set of CRUD methods for managin users, it contains a jwt() method that's used to
...
export class UserService {
    ...
    // Update user
    update(user: User) {
        return this.http.post('/api/users/' + user.id, user, this.jwt()).map((response: Response) => response.json());
    }
